...
= 1.1.0-Beta =
* Added Multiple Payment Accounts: Manage multiple payment accounts with individual API keys and settings.
* Added special character validation on checkout to ensure secure data entry and prevent unsupported or harmful characters.
