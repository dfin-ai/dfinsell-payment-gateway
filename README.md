...
- **WC Version Mismatch Fix:** 
  Resolved WooCommerce version mismatch issues that could prevent activation and cause the DFin Sell gateway to disappear from checkout.
